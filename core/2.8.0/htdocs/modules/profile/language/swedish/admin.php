...
define('_PROFILE_AM_FLOAT', 'Flyttal');
...
define('_PROFILE_AM_UNICODE_TXTAREA', 'Unicode-textområde');
...
//1.62
define('_PROFILE_AM_ACTION', 'Åtgärd');
//1.63
define('_PROFILE_AM_REQUIRED_TOGGLE', 'Växla obligatoriskt fält');
define('_PROFILE_AM_REQUIRED_TOGGLE_SUCCESS', 'Obligatoriskt fält ändrat ');
define('_PROFILE_AM_REQUIRED_TOGGLE_FAILED', 'Ändring av obligatoriskt fält misslyckades');
define('_PROFILE_AM_SAVESTEP_TOGGLE', 'Växla spara');
define('_PROFILE_AM_SAVESTEP_TOGGLE_SUCCESS', 'Spara efter steg ändrat');
define('_PROFILE_AM_SAVESTEP_TOGGLE_FAILED', "Det gick inte att ändra 'Spara efter steg'");
//XOOPS 2.5.9
define('_PROFILE_AM_CANNOTDEACTIVATEWEBMASTERS', 'Du kan inte inaktivera Webmaster-kontot');
//XOOPS 2.5.11
define('_PROFILE_AM_EDIT_OPTION_STRINGS', 'Redigera alternativsträngar');

// 2.7.4
define('_PROFILE_AM_DELETE_FAILED', 'Det gick inte att ta bort %s; kontot togs inte bort');
