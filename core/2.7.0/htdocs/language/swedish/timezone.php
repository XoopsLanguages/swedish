...
define('_TZ_GMTM8', '(GMT-8:00) Pacific Time (USA och Kanada)');
define('_TZ_GMTM7', '(GMT-7:00) Mountain Time (USA och Kanada)');
define('_TZ_GMTM6', '(GMT-6:00) Central Time (USA och Kanada), Mexico City');
define('_TZ_GMTM5', '(GMT-5:00) Eastern Time (USA och Kanada), Bogota, Lima, Quito');
...
define('_TZ_GMTM2', '(GMT-2:00) Mittatlanten');
define('_TZ_GMTM1', '(GMT-1:00) Azorerna, Kap Verdeöarna');
define('_TZ_GMT0', '(GMT) Greenwich Mean Time, London, Dublin, Lissabon, Casablanca, Monrovia');
define('_TZ_GMTP1', '(GMT+1:00) Amsterdam, Berlin, Rom, Köpenhamn, Bryssel, Madrid, Paris');
define('_TZ_GMTP2', '(GMT+2:00) Aten, Istanbul, Minsk, Helsingfors, Jerusalem, Sydafrika');
...
define('_TZ_GMTP8', '(GMT+8:00) Peking, Perth, Singapore, Hongkong, Urumqi, Taipei');
...
define('_TZ_GMTP11', '(GMT+11:00) Magadan, Salomonöarna, Nya Kaledonien');
define('_TZ_GMTP12', '(GMT+12:00) Auckland, Wellington, Fiji, Kamchatka, Marshallön');
