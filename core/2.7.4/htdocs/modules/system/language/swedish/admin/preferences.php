...
// 2.7.4
define('_MD_AM_TWOFACTORMODE', 'Tvåfaktorsautentisering');
define('_MD_AM_TWOFACTORMODEDSC', 'Av pausar varje andrafaktor-kontroll samtidigt som varje medlems registrering behålls. Valfritt låter medlemmar registrera en autentiseringsapp eller e-postkoder, och kontrollerar medlemmar som redan har registrerat sig.');
define('_MD_AM_TWOFACTORMODE_OFF', 'Av (pausad)');
define('_MD_AM_TWOFACTORMODE_OPTIONAL', 'Valfritt');
